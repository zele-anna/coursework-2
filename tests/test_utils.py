...
def test_filter_vacancies(hh_data: list) -> None:
...
def test_get_vacancies_by_salary(hh_data_2: list) -> None:
...
def test_sort_vacancies(hh_data: list) -> None:
    vacancies_list = Vacancy.cast_to_object_list(hh_data)
...
def test_get_top_vacancies(hh_data: list, hh_data_2: list) -> None:
    vacancies_list = Vacancy.cast_to_object_list(hh_data)
    vacancies_list += Vacancy.cast_to_object_list(hh_data_2)
